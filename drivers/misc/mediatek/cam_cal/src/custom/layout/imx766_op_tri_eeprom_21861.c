...
#define PFX "CAM_CAL_IMX766_21861"
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x0148000E, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00000020, 0x0000000E, do_2a_gain_imx766},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT imx766_op_tri_eeprom_21861 = {
	.name = "imx766_op_tri_eeprom_21861",
		...
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData)
{
	...
	pr_debug("IMX766 block_size=%d sensor_id=%x\n", block_size, pCamCalData->sensorID);
