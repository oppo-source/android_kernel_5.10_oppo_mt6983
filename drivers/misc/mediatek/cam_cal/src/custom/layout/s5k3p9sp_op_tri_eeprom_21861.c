...
#define PFX "CAM_CAL_S5K3P9SP_21861"
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x01510062, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00000600, 0x0000074C, do_single_lsc_s5k3p9sp},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT s5k3p9sp_op_tri_eeprom_21861 = {
	.name = "s5k3p9sp_op_tri_eeprom_21861",
