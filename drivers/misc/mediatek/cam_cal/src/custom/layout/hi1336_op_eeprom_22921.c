...
static unsigned int do_single_lsc_hi1336(struct EEPROM_DRV_FD_DATA *pdata,
	unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_hi1336(struct EEPROM_DRV_FD_DATA *pdata,
	unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_hi1336(struct EEPROM_DRV_FD_DATA *pdata,
	unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);

static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000000, 0x01001755, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x00000001, 0x00000001, do_module_version},
		{0x00000001, 0x00000001, 0x00000001, do_part_number},
		{0x00000001, 0x00000037, 0x0000074C, do_single_lsc_hi1336},
		{0x00000001, 0x00000007, 0x0000000E, do_2a_gain_hi1336},  //Start address, block size is useless
		{0x00000001, 0x00000785, 0x000005E1, do_pdaf},
		{0x00000000, 0x00000000, 0x00000000, do_stereo_data},
		{0x00000001, 0x00000000, 0x00002800, do_dump_all},
		{0x00000001, 0x00000003, 0x00000001, do_lens_id_hi1336}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT hi1336_op_eeprom_22921 = {
	.name = "hi1336_op_eeprom_22921",
	...
	unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData)
{
	...
	debug_log("do_single_lsc_hi1336 E\n");
