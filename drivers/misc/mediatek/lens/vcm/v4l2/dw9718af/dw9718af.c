 ...
 */
#define DW9718_START_CODE           200
#define DW9718AF_MOVE_STEPS			40
#define DW9718AF_MOVE_DELAY_US		2500
#define DW9718AF_INIT_DELAY_US		1000

#define DW9718_MIN_CODE              125
#define DW9718AF_RELEASE_STEPS		 10
#define DW9718AF_RELEASE_10MS	 	10000
#define DW9718AF_RELEASE_5MS	 	5000
#define DW9718_RELEASE_FIRST_CODE   200
#define DW9718_RELEASE_SECEND_CODE  160
...
static int dw9718af_release(struct dw9718af_device *dw9718af)
{
	...
	val = val > DW9718_RELEASE_FIRST_CODE ? DW9718_RELEASE_FIRST_CODE : val;
	dw9718af_set_position(dw9718af, val);
	usleep_range(DW9718AF_RELEASE_5MS, DW9718AF_RELEASE_5MS + 1000);
	val = DW9718_RELEASE_SECEND_CODE;
	dw9718af_set_position(dw9718af, val);
	usleep_range(DW9718AF_RELEASE_5MS, DW9718AF_RELEASE_5MS + 1000);
