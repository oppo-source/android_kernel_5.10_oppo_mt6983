...
struct eeprom_map_info imx709_eeprom_info_21121[] = {
                     ...
                     BYTE *data, int size)
{
    ...
    if (meta_id != imx709_eeprom_info_21121[meta_id].meta)
        return -1;

    if (size != imx709_eeprom_info_21121[meta_id].size)
        return -1;

    addr = imx709_eeprom_info_21121[meta_id].start;
    readsize = imx709_eeprom_info_21121[meta_id].size;
