...
static void feedback_awbgain(struct subdrv_ctx *ctx, kal_uint32 r_gain, kal_uint32 b_gain)
{
    ...
    LOG_DEBUG("feedback_awbgain r_gain: %d, b_gain: %d\n", r_gain, b_gain);
...
#define EEPROM_8k 0x8000
    ...
    case SENSOR_FEATURE_SET_AWB_GAIN:
            LOG_DEBUG("SENSOR_FEATURE_SET_AWB_GAIN sensor_mode: %d\n", ctx->sensor_mode);
            /*write AWB gain to sensor*/
    ...
    case SENSOR_FEATURE_GET_BINNING_TYPE:
        ...
        LOG_DEBUG("IMX890 SENSOR_FEATURE_GET_BINNING_TYPE AE_binning_type:%d,\n",
