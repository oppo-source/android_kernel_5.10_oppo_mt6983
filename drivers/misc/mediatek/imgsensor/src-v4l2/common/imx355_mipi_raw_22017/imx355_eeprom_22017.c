...
void imx355_read_SPC_22017(struct subdrv_ctx *ctx, BYTE *data)
{
...
void imx355_read_DCC_22017(struct subdrv_ctx *ctx,
...
struct eeprom_map_info imx355_eeprom_info_22017[] = {
...
unsigned int read_imx355_eeprom_info_22017(struct subdrv_ctx *ctx, kal_uint16 meta_id,
                     BYTE *data, int size)
{
    kal_uint16 addr;
    int readsize;

    if (meta_id != imx355_eeprom_info_22017[meta_id].meta)
        return -1;

    if (size != imx355_eeprom_info_22017[meta_id].size)
        return -1;

    addr = imx355_eeprom_info_22017[meta_id].start;
    readsize = imx355_eeprom_info_22017[meta_id].size;
