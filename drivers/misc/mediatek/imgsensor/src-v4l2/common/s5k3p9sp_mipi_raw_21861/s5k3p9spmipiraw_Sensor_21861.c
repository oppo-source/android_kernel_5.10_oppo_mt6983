...
#include "s5k3p9spmipiraw_Sensor_21861.h"
#include "s5k3p9sp_ana_gain_table_21861.h"
#include "s5k3p9sp_Sensor_setting_21861.h"
#include "s5k3p9sp_eeprom_21861.h"
...
#define s5k3p9sp_table_write_cmos_sensor_8_21861(...) subdrv_i2c_wr_regs_u8(__VA_ARGS__)
#define s5k3p9sp_table_write_cmos_sensor_16_21861(...) subdrv_i2c_wr_regs_u16(__VA_ARGS__)
#define s5k3p9sp_burst_write_cmos_sensor_8_21861(...) subdrv_i2c_wr_p8(__VA_ARGS__)
#define s5k3p9sp_burst_write_cmos_sensor_16_21861(...) subdrv_i2c_wr_p16(__VA_ARGS__)

#define S5K3P9SP_EEPROM_READ_ID_21861  0xA9
#define S5K3P9SP_EEPROM_WRITE_ID_21861 0xA8

#define PFX "S5K3P9SP_camera_sensor_21861"
...
{
	if (_size_to_write) {
		s5k3p9sp_table_write_cmos_sensor_16_21861(ctx, _i2c_data, _size_to_write);
...
static struct imgsensor_info_struct imgsensor_info = {
		.sensor_id = S5K3P9SP_SENSOR_ID_21861,
...
static void sensor_init(struct subdrv_ctx *ctx)
{
	...
	s5k3p9sp_burst_write_cmos_sensor_8_21861(ctx, 0x6F12,
...
#else
	s5k3p9sp_table_write_cmos_sensor_16_21861(ctx, addr_data_pair_init,
...
{
	s5k3p9sp_table_write_cmos_sensor_16_21861(ctx, addr_data_pair_preview_21861,
		   sizeof(addr_data_pair_preview_21861) / sizeof(kal_uint16));
	set_mirror_flip(ctx, ctx->mirror);
}	/*	preview_setting  */

static void capture_setting(struct subdrv_ctx *ctx)
{
	s5k3p9sp_table_write_cmos_sensor_16_21861(ctx, addr_data_pair_capture_21861,
		   sizeof(addr_data_pair_capture_21861) / sizeof(kal_uint16));
	set_mirror_flip(ctx, ctx->mirror);
}	/*	capture_setting  */

static void normal_video_setting(struct subdrv_ctx *ctx)
{
	s5k3p9sp_table_write_cmos_sensor_16_21861(ctx, addr_data_pair_normal_video_21861,
		sizeof(addr_data_pair_normal_video_21861) / sizeof(kal_uint16));
	set_mirror_flip(ctx, ctx->mirror);
}	/*	normal_video_setting  */

static void hs_video_setting(struct subdrv_ctx *ctx)
{
	s5k3p9sp_table_write_cmos_sensor_16_21861(ctx, addr_data_pair_hs_video_21861,
		sizeof(addr_data_pair_hs_video_21861) / sizeof(kal_uint16));
	set_mirror_flip(ctx, ctx->mirror);
	LOG_INF("E\n");
}	/*	hs_video_setting  */
...
{
	s5k3p9sp_table_write_cmos_sensor_16_21861(ctx, addr_data_pair_slim_video_21861,
		   sizeof(addr_data_pair_slim_video_21861) / sizeof(kal_uint16));
	set_mirror_flip(ctx, ctx->mirror);
	LOG_INF("E\n");
}	/*	slim_video_setting  */
...
{
	s5k3p9sp_table_write_cmos_sensor_16_21861(ctx, addr_data_pair_custom1_21861,
		   sizeof(addr_data_pair_custom1_21861) / sizeof(kal_uint16));
	set_mirror_flip(ctx, ctx->mirror);
	LOG_INF("E\n");
}	/*	custom1_setting  */
...
{
	s5k3p9sp_table_write_cmos_sensor_16_21861(ctx, addr_data_pair_custom2_21861,
		   sizeof(addr_data_pair_custom2_21861) / sizeof(kal_uint16));
	set_mirror_flip(ctx, ctx->mirror);
	LOG_INF("E\n");
}	/*	custom2_setting  */
...
{
	s5k3p9sp_table_write_cmos_sensor_16_21861(ctx, addr_data_pair_custom3_21861,
		   sizeof(addr_data_pair_custom3_21861) / sizeof(kal_uint16));
	set_mirror_flip(ctx, ctx->mirror);
	LOG_INF("E\n");
}	/*	custom3_setting  */
...
static void read_four_cell_from_eeprom(struct subdrv_ctx *ctx, char *data)
{
	...
	if (data != NULL) {
		...
		ret = adaptor_i2c_rd_u8(ctx->i2c_client,
			S5K3P9SP_EEPROM_READ_ID_21861 >> 1, FOUR_CELL_ADDR, &temp);
		if (ret < 0) {
		...
		for (i = 2; i < (FOUR_CELL_SIZE + 2); i++)
			adaptor_i2c_rd_u8(ctx->i2c_client,
				S5K3P9SP_EEPROM_READ_ID_21861 >> 1, FOUR_CELL_ADDR, &four_cell_data[i]);
 ...
 ************************************************************************
 */
static BYTE s5k3p9sp_common_data_21861[OPLUS_CAMERA_COMMON_DATA_LENGTH] = { 0 };
static void read_module_data(struct subdrv_ctx *ctx)
{
	kal_uint16 idx = 0;
	read_s5k3p9sp_eeprom_info_21861(ctx, EEPROM_META_MODULE_ID,
				&(s5k3p9sp_common_data_21861[0]), 2);
	imgsensor_info.module_id = (kal_uint16)(s5k3p9sp_common_data_21861[1] << 8) |
				   s5k3p9sp_common_data_21861[0];
	read_s5k3p9sp_eeprom_info_21861(ctx, EEPROM_META_SENSOR_ID,
				&(s5k3p9sp_common_data_21861[2]), 2);
	read_s5k3p9sp_eeprom_info_21861(ctx, EEPROM_META_LENS_ID,
				&(s5k3p9sp_common_data_21861[4]), 2);
	read_s5k3p9sp_eeprom_info_21861(ctx, EEPROM_META_VCM_ID,
				&(s5k3p9sp_common_data_21861[6]), 2);
	read_s5k3p9sp_eeprom_info_21861(ctx, EEPROM_META_MODULE_SN,
				&(s5k3p9sp_common_data_21861[8]), 17);

	for (idx = 0; idx < 30; idx = idx + 4)
		printk(KERN_ERR "cam data: %02x %02x %02x %02x\n",
		       s5k3p9sp_common_data_21861[idx], s5k3p9sp_common_data_21861[idx + 1],
		       s5k3p9sp_common_data_21861[idx + 2],
		       s5k3p9sp_common_data_21861[idx + 3]);
}
	...
	UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(s5k3p9sp_ana_gain_table_21861);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)s5k3p9sp_ana_gain_table_21861,
			sizeof(s5k3p9sp_ana_gain_table_21861));
		}
		break;
	...
	case SENSOR_FEATURE_GET_EEPROM_COMDATA:
		memcpy(feature_return_para_32, s5k3p9sp_common_data_21861,
...
const struct subdrv_entry s5k3p9sp_mipi_raw_21861_entry = {
	.name = "s5k3p9sp_mipi_raw_21861",
	.id = S5K3P9SP_SENSOR_ID_21861,
	.pw_seq = pw_seq,
