...
static void read_unique_sensorid(struct subdrv_ctx *ctx)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xFF) {
        ...
        if (adaptor_i2c_rd_p8(ctx->i2c_client, ctx->i2c_write_id >> 1, OMEGAC2MAIN_UNIQUE_SENSOR_ID_ADDR_23081,
                &(omegac2main_unique_id[0]), OMEGAC2MAIN_UNIQUE_SENSOR_ID_LENGHT_23081) < 0) {
