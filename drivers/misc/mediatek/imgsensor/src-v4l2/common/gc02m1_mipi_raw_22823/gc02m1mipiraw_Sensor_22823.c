...
#include "gc02m1mipiraw_Sensor_22823.h"
#include "gc02m1_eeprom_22823.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1_SENSOR_ID_22823,
...
kal_uint16 addr_data_pair_init_gc02m1_22823[] = {
	/*system*/
	0xfc, 0x01,
	0xf4, 0x41,
	0xf5, 0xe3,
...
kal_uint16 addr_data_pair_preview_gc02m1_22823[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_capture_gc02m1_22823[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_normal_video_gc02m1_22823[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_hs_video_gc02m1_22823[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_slim_video_gc02m1_22823[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};
...
static void sensor_init(struct subdrv_ctx *ctx)
{
	...
	gc02m1_table_write_cmos_sensor_8(ctx,
	    addr_data_pair_init_gc02m1_22823,
		sizeof(addr_data_pair_init_gc02m1_22823) /
		sizeof(kal_uint16));
...
static void preview_setting(struct subdrv_ctx *ctx)
{
	...
	gc02m1_table_write_cmos_sensor_8(ctx,
		addr_data_pair_preview_gc02m1_22823,
		sizeof(addr_data_pair_preview_gc02m1_22823) /
		sizeof(kal_uint16));
...
static void capture_setting(struct subdrv_ctx *ctx)
{
	...
	gc02m1_table_write_cmos_sensor_8(ctx,
		addr_data_pair_capture_gc02m1_22823,
		sizeof(addr_data_pair_capture_gc02m1_22823) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(struct subdrv_ctx *ctx)
{
	...
	gc02m1_table_write_cmos_sensor_8(ctx,
	    addr_data_pair_normal_video_gc02m1_22823,
		sizeof(addr_data_pair_normal_video_gc02m1_22823) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(struct subdrv_ctx *ctx)
{
	...
	gc02m1_table_write_cmos_sensor_8(ctx,
		addr_data_pair_hs_video_gc02m1_22823,
		sizeof(addr_data_pair_hs_video_gc02m1_22823) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(struct subdrv_ctx *ctx)
{
	...
	gc02m1_table_write_cmos_sensor_8(ctx,
		addr_data_pair_slim_video_gc02m1_22823,
		sizeof(addr_data_pair_slim_video_gc02m1_22823) /
		sizeof(kal_uint16));
}
...
{
    kal_uint16 idx = 0;
    read_gc02m1_eeprom_info_22823(ctx, EEPROM_META_MODULE_ID,
                &(gc02m1_common_data[0]), 2);
    read_gc02m1_eeprom_info_22823(ctx, EEPROM_META_SENSOR_ID,
                &(gc02m1_common_data[2]), 2);
    read_gc02m1_eeprom_info_22823(ctx, EEPROM_META_LENS_ID,
                &(gc02m1_common_data[4]), 2);
    read_gc02m1_eeprom_info_22823(ctx, EEPROM_META_VCM_ID,
                &(gc02m1_common_data[6]), 2);
    read_gc02m1_eeprom_info_22823(ctx, EEPROM_META_MODULE_SN,
...
const struct subdrv_entry gc02m1_mipi_raw_22823_entry = {
	.name = "gc02m1_mipi_raw_22823",
	.id = GC02M1_SENSOR_ID_22823,
	.pw_seq = pw_seq,
