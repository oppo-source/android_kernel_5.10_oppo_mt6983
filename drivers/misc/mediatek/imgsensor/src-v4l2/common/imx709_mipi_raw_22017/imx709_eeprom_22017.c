...
unsigned int read_imx709_LRC_22017(struct subdrv_ctx *ctx, kal_uint16 *data)
{
...
unsigned int read_imx709_QSC_22017(struct subdrv_ctx *ctx, kal_uint8 *data)
{
    kal_uint16 idx = 0;
    kal_uint8 qsc_ver = 0;
...
struct eeprom_map_info imx709_eeprom_info_22017[] = {
...
unsigned int read_imx709_eeprom_info_22017(struct subdrv_ctx *ctx, kal_uint16 meta_id,
                     BYTE *data, int size)
{
    kal_uint16 addr;
    int readsize;

    if (meta_id != imx709_eeprom_info_22017[meta_id].meta)
        return -1;

    if (size != imx709_eeprom_info_22017[meta_id].size)
        return -1;

    addr = imx709_eeprom_info_22017[meta_id].start;
    readsize = imx709_eeprom_info_22017[meta_id].size;
