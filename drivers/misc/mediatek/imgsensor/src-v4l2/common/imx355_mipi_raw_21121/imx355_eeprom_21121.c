...
void imx355_read_SPC_21121(struct subdrv_ctx *ctx, BYTE *data)
{
...
struct eeprom_map_info imx355_eeprom_info_21121[] = {
                     ...
                     BYTE *data, int size)
{
    ...
    if (meta_id != imx355_eeprom_info_21121[meta_id].meta)
        return -1;

    if (size != imx355_eeprom_info_21121[meta_id].size)
        return -1;

    addr = imx355_eeprom_info_21121[meta_id].start;
    readsize = imx355_eeprom_info_21121[meta_id].size;
