...
#include "imx890mipiraw_Sensor_23251.h"
#include "imx890_eeprom_23251.h"
#include "imx890_ana_gain_table_23251.h"
#include "imx890_Sensor_setting_23251.h"
...
#define PFX "IMX890_camera_sensor_23251"
...
#endif
static struct oplus_get_eeprom_common_data imx890_common_data = {0};
...
static kal_uint16 read_cmos_eeprom_8(struct subdrv_ctx *ctx, kal_uint16 addr)
{
    ...
    adaptor_i2c_rd_u8(ctx->i2c_client, IMX890_EEPROM_READ_ID_23251 >> 1, addr, (u8 *)&get_byte);
    return get_byte;
}
                   ...
                   BYTE *data, int size)
{
    ...
    if (adaptor_i2c_rd_p8(ctx->i2c_client, IMX890_EEPROM_READ_ID_23251 >> 1,
                addr, data, size) < 0) {
        return false;
    }
    return true;
        ...
        kal_uint16 addr, kal_uint8 *para, kal_uint32 len)
{
    ...
    ret = adaptor_i2c_wr_p8(ctx->i2c_client, IMX890_EEPROM_WRITE_ID_23251 >> 1,
            addr, para, len);
...
{
    kal_int32 ret = ERROR_NONE;
    kal_uint16 reg = IMX890_EEPROM_LOCK_REGISTER_23251;
    if (enable) {
        adaptor_i2c_wr_u8(ctx->i2c_client, IMX890_EEPROM_WRITE_ID_23251 >> 1,
            reg, (IMX890_EEPROM_WRITE_ID_23251 & 0xFE) | 0x01);
    }
    else {
        adaptor_i2c_wr_u8(ctx->i2c_client, IMX890_EEPROM_WRITE_ID_23251 >> 1,
            reg, IMX890_EEPROM_WRITE_ID_23251 & 0xFE);
    }
...
static kal_int32 eeprom_table_write_23251(struct subdrv_ctx *ctx, kal_uint16 data_base, kal_uint8 *pData, kal_uint16 data_length) {
...
static kal_int32 eeprom_64align_write_23251(struct subdrv_ctx *ctx, kal_uint16 data_base, kal_uint8 *pData, kal_uint16 data_length) {
	...
	if (part1_length) {
		ret = eeprom_table_write_23251(ctx, data_base, pData, part1_length);
		if (ret == -1) {
			/* open write protect */
	...
	msleep(6);
	if (part2_length) {
		ret = eeprom_table_write_23251(ctx, addr_64align, pData + part1_length, part2_length);
		if (ret == -1) {
			/* open write protect */
			write_eeprom_protect(ctx, 1);
            ...
            ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
    ...
    if(pStereodata != NULL) {
        ...
        if ((pStereodata->uSensorId == IMX890_SENSOR_ID_23251) && (data_length == CALI_DATA_MASTER_LENGTH)
            && (data_base == IMX890_STEREO_MT_START_ADDR_23251 || data_base == IMX890_STEREO_MW_START_ADDR_23251)) {
            LOG_INF("Write: %x %x %x %x\n", pData[0], pData[39], pData[40], pData[1556]);

            eeprom_64align_write_23251(ctx, data_base, pData, data_length);
        ...
        } else if ((pStereodata->uSensorId == IMX890_SENSOR_ID_23251) && (data_length < AESYNC_DATA_LENGTH_TOTAL)
            && (data_base == IMX890_AESYNC_START_ADDR_23251)) {
            ...
            LOG_INF("readback main aesync: %x %x %x %x %x %x %x %x\n",
                    read_cmos_eeprom_8(ctx, IMX890_AESYNC_START_ADDR_23251),
                    read_cmos_eeprom_8(ctx, IMX890_AESYNC_START_ADDR_23251+1),
                    read_cmos_eeprom_8(ctx, IMX890_AESYNC_START_ADDR_23251+2),
                    read_cmos_eeprom_8(ctx, IMX890_AESYNC_START_ADDR_23251+3),
                    read_cmos_eeprom_8(ctx, IMX890_AESYNC_START_ADDR_23251+4),
                    read_cmos_eeprom_8(ctx, IMX890_AESYNC_START_ADDR_23251+5),
                    read_cmos_eeprom_8(ctx, IMX890_AESYNC_START_ADDR_23251+6),
                    read_cmos_eeprom_8(ctx, IMX890_AESYNC_START_ADDR_23251+7));
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX890_SENSOR_ID_23251,
    ...
    .normal_video = { /* Reg_M3_S3_4096x3072_30FPS 1DOL seamless M4_S3(custom4)*/
        .pclk = 2246400000,
        .linelength = 15616,
        .framelength = 4794,
        .startx = 0,
    ...
    .hs_video = { /* Reg_E1_4096x2304_60FPS */
        .pclk = 3052800000,
        .linelength = 15616,
        .framelength = 3258,
        .startx = 0,
    ...
    .custom2 = { /* reg_B2 QBIN(VBIN)_4096x3072 @24FPS  Tline Min 4.44us */
        .pclk = 1523200000,
        .linelength = 15616,
        .framelength = 4064,
        .startx = 0,
    ...
    .custom4 = { /* Reg_M4-S3 4096x2304_30FPS, 2DOL Video  seamless M3_S3 (normal_video)*/
        .pclk = 2246400000,
        .linelength = 15616,
        .framelength = 4792,
        .startx = 0,
    ...
    .custom8 = { /* Reg_M3_S3_4096x3072_30FPS 1DOL seamless M4_S3(custom4)*/
        .pclk = 2246400000,
        .linelength = 15616,
        .framelength = 4794,
        .startx = 0,
    ...
    .custom10 = { /* QBin(VBin) V2H2 2048x1536 @24fps w/ PD VB<10ms, DataRate 502 */
        .pclk = 1286400000,
        .linelength = 26448,
        .framelength = 2024,
        .startx = 0,
    ...
    .custom11 = { /* Reg_K8-1_4096x3072_30FPS */
        .pclk = 3014400000,
        .linelength = 15616,
        .framelength = 6434,
        .startx = 0,
...
static void read_module_data(struct subdrv_ctx *ctx)
{
	...
	memset(&imx890_common_data, 0x00, sizeof(imx890_common_data));

	imx890_common_data.header[EEPROM_MODULE_ID] = 2;
	read_imx890_eeprom_info_23251(ctx, EEPROM_META_MODULE_ID,
				&(imx890_common_data.data[idx]), 2);
	imgsensor_info.module_id = (kal_uint16)(imx890_common_data.data[idx + 1] << 8) |
				   imx890_common_data.data[idx];
	idx += imx890_common_data.header[EEPROM_MODULE_ID];

	imx890_common_data.header[EEPROM_SENSOR_ID] = 2;
	read_imx890_eeprom_info_23251(ctx, EEPROM_META_SENSOR_ID,
				&(imx890_common_data.data[idx]), 2);
	idx += imx890_common_data.header[EEPROM_SENSOR_ID];

	imx890_common_data.header[EEPROM_LENS_ID] = 2;
	read_imx890_eeprom_info_23251(ctx, EEPROM_META_LENS_ID,
				&(imx890_common_data.data[idx]), 2);
	idx += imx890_common_data.header[EEPROM_LENS_ID];

	imx890_common_data.header[EEPROM_VCM_ID] = 2;
	read_imx890_eeprom_info_23251(ctx, EEPROM_META_VCM_ID,
				&(imx890_common_data.data[idx]), 2);
	idx += imx890_common_data.header[EEPROM_VCM_ID];

	imx890_common_data.header[EEPROM_MODULE_SN] = 17;
	read_imx890_eeprom_info_23251(ctx, EEPROM_META_MODULE_SN,
				&(imx890_common_data.data[idx]), 17);
	idx += imx890_common_data.header[EEPROM_MODULE_SN];

	imx890_common_data.header[EEPROM_AF_CODE_MACRO] = 2;
	imx890_common_data.header[EEPROM_AF_CODE_INFINITY] = 2;
	imx890_common_data.header[EEPROM_AF_CODE_MIDDLE] = 2;
	read_imx890_eeprom_info_23251(ctx, EEPROM_META_AF_CODE,
				&(imx890_common_data.data[idx]), 6);
    ...
    for (idx = 0; idx < 32; idx = idx + 4)
        LOG_INF("In %s:common data: %02x %02x %02x %02x\n", __func__,
               imx890_common_data.data[idx], imx890_common_data.data[idx + 1],
               imx890_common_data.data[idx + 2],
               imx890_common_data.data[idx + 3]);

//    imx890_common_data.data[AF_CODE_MACRO_idx] =
//		(kal_uint8)((imx890_common_data.data[AF_CODE_MACRO_idx + 1] << 6) | (imx890_common_data.data[AF_CODE_MACRO_idx] >> 2));
//    imx890_common_data.data[AF_CODE_MACRO_idx + 1] = (kal_uint8)(imx890_common_data.data[AF_CODE_MACRO_idx +1] >> 2);

//    imx890_common_data.data[AF_CODE_INFINITY_idx] =
//		(kal_uint8)((imx890_common_data.data[AF_CODE_INFINITY_idx + 1] << 6) | (imx890_common_data.data[AF_CODE_INFINITY_idx] >> 2));
//    imx890_common_data.data[AF_CODE_INFINITY_idx + 1] = (kal_uint8)(imx890_common_data.data[AF_CODE_INFINITY_idx +1] >> 2);

//    imx890_common_data.data[AF_CODE_MIDDLE_idx] =
//		(kal_uint8)((imx890_common_data.data[AF_CODE_MIDDLE_idx + 1] << 6) | (imx890_common_data.data[AF_CODE_MIDDLE_idx] >> 2));
//    imx890_common_data.data[AF_CODE_MIDDLE_idx + 1] = (kal_uint8)(imx890_common_data.data[AF_CODE_MIDDLE_idx +1] >> 2);
...
static void sensor_init(struct subdrv_ctx *ctx)
{
    ...
    if (sensor_id == IMX890_SENSOR_ID) {
        ...
        imx890_table_write_cmos_sensor_8(ctx, imx890_init_otp_setting_23251,
            sizeof(imx890_init_otp_setting_23251)/sizeof(kal_uint16));
        LOG_INF("write 890 OTP -\n");
    }
    imx890_table_write_cmos_sensor_8(ctx, imx890_init_setting_23251,
        sizeof(imx890_init_setting_23251)/sizeof(kal_uint16));
...
/*
unsigned short imx890_seamless_preview_Optimize1_23251[] = {
    0x38B0,0x00,
    0x38B1,0x00,
    0x38B2,0x00,
    0x38B3,0x00,
...
unsigned short imx890_seamless_custom5_Optimize1_23251[] = {
    0x38B0,0x00,
    0x38B1,0x86,
    0x38B2,0x00,
    0x38B3,0x86,
        ...
        enum SENSOR_SCENARIO_ID_ENUM scenario_id, uint32_t *ae_ctrl)
{
    ...
    case SENSOR_SCENARIO_ID_CUSTOM4:
    {
        unsigned short imx890_seamless_custom4[] = {  //2dol
            0x0340, 0x09,
            0x0341, 0x5C,
            0x0202, 0x07,
            0x0203, 0xE0,
        ...
        FMC_GPH_START;
        imx890_table_write_cmos_sensor_8(ctx, imx890_seamless_custom4,
                sizeof(imx890_seamless_custom4) / sizeof(kal_uint16));

        if (ae_ctrl) {
            LOG_INF("call SENSOR_SCENARIO_ID_CUSTOM4 %d %d %d %d",
    ...
    case SENSOR_SCENARIO_ID_CUSTOM8:
    {
        unsigned short imx890_seamless_custom8[] = {  //1dol
            0x0340, 0x12,
            0x0341, 0xBA,
            0x0202, 0x12,
            0x0203, 0x8A,
                ...
                UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
        if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
            *(feature_data + 0) =
                sizeof(imx890_ana_gain_table_23251);
        } else {
            memcpy((void *)(uintptr_t) (*(feature_data + 1)),
            (void *)imx890_ana_gain_table_23251,
            sizeof(imx890_ana_gain_table_23251));
        }
        break;
...
*/
    ...
    case SENSOR_FEATURE_GET_EEPROM_COMDATA:
        if(*feature_para_len == sizeof(imx890_common_data) && feature_return_para_32 != feature_para_len) {
            memcpy(feature_return_para_32, &imx890_common_data,
                sizeof(imx890_common_data));
        }
        break;
    case SENSOR_FEATURE_GET_EEPROM_STEREODATA:
        ...
        case EEPROM_STEREODATA_MT_MAIN:
            read_imx890_eeprom_info_23251(ctx, EEPROM_META_STEREO_MT_MAIN_DATA,
                    (BYTE *)feature_return_para_32, *feature_para_len);
            break;
        case EEPROM_STEREODATA_MW_MAIN:
        default:
            read_imx890_eeprom_info_23251(ctx, EEPROM_META_STEREO_MW_MAIN_DATA,
                    (BYTE *)feature_return_para_32, *feature_para_len);
            break;
        }
        break;
#define EEPROM_8k 0x8000
    case SENSOR_FEATURE_GET_SENSOR_OTP_ALL:
        ...
        read_imx890_eeprom_23251(ctx, 0x00, (BYTE *)feature_return_para_32, *feature_para_len);
    break;
...
//            break;
    ...
    case SENSOR_FEATURE_GET_CUST_PIXEL_RATE:
        ...
        switch (*feature_data) {
            case SENSOR_SCENARIO_ID_CUSTOM4:
                *(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 592800000;
                break;
            case SENSOR_SCENARIO_ID_CUSTOM8:
                *(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 592800000;
                break;
    ...
    struct mtk_csi_param *csi_param)
{
	...
	case SENSOR_SCENARIO_ID_NORMAL_PREVIEW:
	case SENSOR_SCENARIO_ID_NORMAL_CAPTURE:
  		csi_param->cphy_settle = 0x5a;
  		break;
	case SENSOR_SCENARIO_ID_NORMAL_VIDEO:
	case SENSOR_SCENARIO_ID_CUSTOM8:
  		csi_param->cphy_settle = 0x41;
  		break;
	case SENSOR_SCENARIO_ID_HIGHSPEED_VIDEO:
	case SENSOR_SCENARIO_ID_CUSTOM2:
  		csi_param->cphy_settle = 0x38;
  		break;
	case SENSOR_SCENARIO_ID_SLIM_VIDEO:
	case SENSOR_SCENARIO_ID_CUSTOM1:
  		csi_param->cphy_settle = 0x3d;
  		break;
	case SENSOR_SCENARIO_ID_CUSTOM3:
  		csi_param->cphy_settle = 0x42;
  		break;
	case SENSOR_SCENARIO_ID_CUSTOM4:
  		csi_param->cphy_settle = 0x41;
  		break;
	case SENSOR_SCENARIO_ID_CUSTOM5:
  		csi_param->cphy_settle = 0x43;
  		break;
	case SENSOR_SCENARIO_ID_CUSTOM6:
  		csi_param->cphy_settle = 0x3C;
  		break;
	case SENSOR_SCENARIO_ID_CUSTOM7:
	case SENSOR_SCENARIO_ID_CUSTOM9:
	case SENSOR_SCENARIO_ID_CUSTOM10:
...
const struct subdrv_entry imx890_mipi_raw_23251_entry = {
    .name = "imx890_mipi_raw_23251",
    .id = IMX890_SENSOR_ID_23251,
    .pw_seq = pw_seq,
