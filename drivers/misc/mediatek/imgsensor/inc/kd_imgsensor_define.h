...
enum SENSOR_SCENARIO_ENUM{
	...
	AON_MASK = MASK_BASE << 3,
	AI_VIDEO_MASK = MASK_BASE << 4,
	PORTRAIT_MASK = MASK_BASE << 5,
	RMSC_MASK = MASK_BASE << 6,
	FACE_UNLOCK_MASK = MASK_BASE << 7,
	HS_VIDEO_MASK = MASK_BASE << 8,
	SLIM_VIDEO_MASK = MASK_BASE << 9,
};
