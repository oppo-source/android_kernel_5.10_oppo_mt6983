...
struct IMGSENSOR_HW_CFG imgsensor_25221_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
			IMGSENSOR_I2C_DEV_0,
			{
				{IMGSENSOR_HW_PIN_MCLK,  IMGSENSOR_HW_ID_MCLK},
				{IMGSENSOR_HW_PIN_AVDD,  IMGSENSOR_HW_ID_NONE},
				{IMGSENSOR_HW_PIN_AFVDD, IMGSENSOR_HW_ID_NONE},
				{IMGSENSOR_HW_PIN_DOVDD, IMGSENSOR_HW_ID_NONE},
				{IMGSENSOR_HW_PIN_DVDD,  IMGSENSOR_HW_ID_NONE},
				{IMGSENSOR_HW_PIN_PDN,   IMGSENSOR_HW_ID_GPIO},
				{IMGSENSOR_HW_PIN_RST,   IMGSENSOR_HW_ID_GPIO},
				{IMGSENSOR_HW_PIN_NONE,  IMGSENSOR_HW_ID_NONE},
