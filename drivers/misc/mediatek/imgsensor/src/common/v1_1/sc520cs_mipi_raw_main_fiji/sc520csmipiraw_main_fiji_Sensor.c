...
#include "sc520csmipiraw_main_fiji_Sensor.h"

#define SC520CS_EEPROM_I2C_ADDR 0xA0
#define MULTI_WRITE 1
#define LOG_TAG "sc520cs_camera_sensor_main"
#define DEVICE_VERSION_SC520CS_FIJI "sc520cs_fiji"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = SC520CS_SENSOR_ID_MAIN_FIJI,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_sc520cs_main[] = {
	0x0100, 0x00,
	0x36e9, 0x80,
	0x37f9, 0x80,
	0x36ea, 0x0e,
...
static void sensor_init(void)
{
	...
	sc520cs_table_write_cmos_sensor(
		addr_data_pair_init_sc520cs_main,
		sizeof(addr_data_pair_init_sc520cs_main) /
		sizeof(kal_uint16));
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_sc520cs_main[] = {
	0x0100, 0x00,
	0x36e9, 0x80,
	0x37f9, 0x80,
	0x36ea, 0x0e,
...
#if MULTI_WRITE
	sc520cs_table_write_cmos_sensor(
		addr_data_pair_preview_sc520cs_main,
		sizeof(addr_data_pair_preview_sc520cs_main) /
		sizeof(kal_uint16));
	if ((read_cmos_sensor(0x800B)&0xFF)==0)
	{
		write_cmos_sensor8(0x550F,0x42);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_fps_sc520cs_main[] = {
	0x0100, 0x00,
	0x36e9, 0x80,
	0x37f9, 0x80,
	0x36ea, 0x0e,
...
#if MULTI_WRITE
	sc520cs_table_write_cmos_sensor(
		addr_data_pair_capture_fps_sc520cs_main,
		sizeof(addr_data_pair_capture_fps_sc520cs_main) /
		sizeof(kal_uint16));
	if ((read_cmos_sensor(0x800B)&0xFF)==0)
	{
		write_cmos_sensor8(0x550F,0x42);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_normal_video_sc520cs_main[] = {
	0x36e9, 0x80,
	0x37f9, 0x80,
	0x36ea, 0x0e,
	0x36eb, 0x0c,
...
static void normal_video_setting(void)
{
...
#if MULTI_WRITE
	sc520cs_table_write_cmos_sensor(
		addr_data_pair_normal_video_sc520cs_main,
		sizeof(addr_data_pair_normal_video_sc520cs_main) /
		sizeof(kal_uint16));
	if ((read_cmos_sensor(0x800B)&0xFF)==0)
	{
		write_cmos_sensor8(0x550F,0x42);
	...
	write_cmos_sensor8(0x36e9,0x44);
	write_cmos_sensor8(0x37f9,0x23);
	write_cmos_sensor8(0x301f,0x8f);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_sc520cs_main[] = {
	0x36e9, 0x80,
	0x37f9, 0x80,
	0x36ea, 0x0e,
	0x36eb, 0x0c,
...
static void hs_video_setting(void)
{
...
#if MULTI_WRITE
	sc520cs_table_write_cmos_sensor(
	addr_data_pair_hs_video_sc520cs_main,
		sizeof(addr_data_pair_hs_video_sc520cs_main) /
		sizeof(kal_uint16));
	if ((read_cmos_sensor(0x800B)&0xFF)==0)
	{
		write_cmos_sensor8(0x550F,0x42);
	...
	write_cmos_sensor8(0x36e9,0x44);
	write_cmos_sensor8(0x37f9,0x23);
	write_cmos_sensor8(0x301f,0x90);
	write_cmos_sensor8(0x3205,0x27);
...
static kal_uint16 read_sc520cs_fiji_eeprom_module(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };
...
// QR       : [4 ~ 20]
	...
	kal_uint16 idx = 0;
	kal_uint16 sn_length = 15;
	kal_uint32 sn_starAddr = 0x76F;
	kal_uint32 moduleAddr = 0x02;
	kal_uint32 sensorAddr = 0x06;
	kal_uint32 lensAddr = 0x07;
	kal_uint32 vcmAddr = 0x08;

	memset(sc520cs_common_data, 0,sizeof(sc520cs_common_data));
	// QR
	for(idx = 0; idx < sn_length; idx++)
	{
		sc520cs_common_data[4 + idx] = read_sc520cs_fiji_eeprom_module(sn_starAddr + idx);
	}
	//module id
	sc520cs_common_data[0] = read_sc520cs_fiji_eeprom_module(moduleAddr);
	//sensor id
	sc520cs_common_data[1] = read_sc520cs_fiji_eeprom_module(sensorAddr);
	//lens id
	sc520cs_common_data[2] = read_sc520cs_fiji_eeprom_module(lensAddr);
	//vcm id
	sc520cs_common_data[3] = read_sc520cs_fiji_eeprom_module(vcmAddr);
...
char main_camera_info[20] = {0};
EXPORT_SYMBOL(main_camera_info);
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
			...
			do {
				*sensor_id =return_sensor_id() + 1;
				sprintf(main_camera_info, "sc520cs");

				if (*sensor_id == imgsensor_info.sensor_id) {
					LOG_INF("i2c write id  : 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
					if(deviceInfo_register_value == 0x00) {
						register_imgsensor_deviceinfo("Cam_f", DEVICE_VERSION_SC520CS_FIJI, imgsensor_info.module_id);
