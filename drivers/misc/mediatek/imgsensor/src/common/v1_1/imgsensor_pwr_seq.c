...
//24267 -
//25221 +
#if defined(OV50D40_MIPI_RAW_25221)
		{
			SENSOR_DRVNAME_OV50D40_MIPI_RAW_25221,
			{
				{RST, Vol_Low, 1},
				{AFVDD, Vol_2800, 1},
				{DOVDD, Vol_1800, 3},
...
#endif
#if defined(GC32E2_MIPI_RAW_25221)
		{
			SENSOR_DRVNAME_GC32E2_MIPI_RAW_25221,
			{
				{SensorMCLK, Vol_High, 0},
				{RST, Vol_Low,  1},
				{DOVDD, Vol_1800, 1},
...
#endif
#if defined(IMX480_MIPI_RAW_25221)
		{
			SENSOR_DRVNAME_IMX480_MIPI_RAW_25221,
			{
				{RST, Vol_Low, 1},
				{AVDD, Vol_2900, 0},
				{DVDD, Vol_1100, 0},
...
#endif
#if defined(SC201CS_MIPI_RAW_25221)
		{
			SENSOR_DRVNAME_SC201CS_MIPI_RAW_25221,
			{
				{RST, Vol_Low, 1},
				{DOVDD, Vol_1800, 1},
				{AVDD, Vol_2800, 5},
