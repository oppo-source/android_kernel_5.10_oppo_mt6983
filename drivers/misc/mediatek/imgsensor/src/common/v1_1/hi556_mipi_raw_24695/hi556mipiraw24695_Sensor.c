...
#include "hi556mipiraw24695_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI556_SENSOR_ID_24695,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	// preview
{ 2608, 1960,    0,    6, 2608, 1948, 2608, 1948,
	 8,    2, 2592, 1944,    0,    0, 2592, 1944},
	// capture
{ 2608, 1960,    0,    6, 2608, 1948, 2608, 1948,
	 8,    2, 2592, 1944,    0,    0, 2592, 1944},
	// video
{ 2608, 1960,    0,    249, 2608, 1462, 2608, 1462,
	 8,    2, 2592, 1458,    0,    0, 2592, 1458},
	// high speed video
{ 2608, 1960,   0,   496, 2608, 968, 1304, 484,
	 332,   2,  640,  480,    0,    0,  640,  480},
	// slim video
{ 2608, 1960,   0,  256, 2608, 1448, 1304, 724,
	 12,    2, 1280,  720,    0,    0, 1280,  720},
};
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_hi556_24695[] = {
    0x0e00, 0x0102,
    0x0e02, 0x0102,
    0x0e0c, 0x0100,
    0x2000, 0x7400,
...
static void sensor_init(void)
{
	...
	hi556_table_write_cmos_sensor(
		addr_data_pair_init_hi556_24695,
		sizeof(addr_data_pair_init_hi556_24695) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_30fps_hi556_24695[] = {
    0x0a00, 0x0000,
    0x0b0a, 0x8252,
    0x0f30, 0x6e25,
    0x0f32, 0x7067,
...
#if MULTI_WRITE
	hi556_table_write_cmos_sensor(
		addr_data_pair_preview_30fps_hi556_24695,
		sizeof(addr_data_pair_preview_30fps_hi556_24695) /
		sizeof(kal_uint16));
#else
	LOG_INF("%s fps = 300\n", __func__);
	write_cmos_sensor(0x0b0a, 0x8252);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_fps_hi556_24695[] = {
    0x0a00, 0x0000,
    0x0b0a, 0x8252,
    0x0f30, 0x6e25,
    0x0f32, 0x7067,
...
kal_uint16 addr_data_pair_capture_30fps_hi556_24695[] = {
    0x0a00, 0x0000,
    0x0b0a, 0x8252,
    0x0f30, 0x6e25,
    0x0f32, 0x7067,
...
kal_uint16 addr_data_pair_normal_video_30fps_hi556_24695[] = {
    0x0a00, 0x0000,
    0x0b0a, 0x8252,
    0x0f30, 0x6e25,
    0x0f32, 0x7067,
...
static void video_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
		hi556_table_write_cmos_sensor(
			addr_data_pair_normal_video_30fps_hi556_24695,
			sizeof(addr_data_pair_normal_video_30fps_hi556_24695) /
			sizeof(kal_uint16));
	} else {
		hi556_table_write_cmos_sensor(
			addr_data_pair_capture_fps_hi556_24695,
			sizeof(addr_data_pair_capture_fps_hi556_24695) /
			sizeof(kal_uint16));
	}
#else
	if (currefps == 300) {
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
		hi556_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_hi556_24695,
			sizeof(addr_data_pair_capture_30fps_hi556_24695) /
			sizeof(kal_uint16));
	} else {
		hi556_table_write_cmos_sensor(
			addr_data_pair_capture_fps_hi556_24695,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_hi556_24695[] = {
    0x0a00, 0x0000,
    0x0b0a, 0x8252,
    0x0f30, 0x6e25,
    0x0f32, 0x7267,
...
#if MULTI_WRITE
	hi556_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi556_24695,
		sizeof(addr_data_pair_hs_video_hi556_24695) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0b0a, 0x8252);
	write_cmos_sensor(0x0f30, 0x6925);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_hi556_24695[] = {
    0x0a00, 0x0000,
    0x0b0a, 0x8252,
    0x0f30, 0x6e25,
    0x0f32, 0x7167,
...
#if MULTI_WRITE
	hi556_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi556_24695,
		sizeof(addr_data_pair_slim_video_hi556_24695) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0b0a, 0x8252);
	write_cmos_sensor(0x0f30, 0x6925);
