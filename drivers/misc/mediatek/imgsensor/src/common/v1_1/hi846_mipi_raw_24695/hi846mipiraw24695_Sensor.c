...
#include "hi846mipiraw24695_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI846_SENSOR_ID_24695,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_hi846_24695[] = {
    0x0066, 0x0101,
    0x2000, 0x98E8,
    0x2002, 0x00FF,
    0x2004, 0x0006,
...
static void sensor_init(void)
{
	...
	hi846_table_write_cmos_sensor(
		addr_data_pair_init_hi846_24695,
		sizeof(addr_data_pair_init_hi846_24695) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_hi846_24695[] = {
    0x002E, 0x1111,
    0x0032, 0x1111,
    0x0026, 0x0040,
    0x002C, 0x09CF,
...
#if MULTI_WRITE
	hi846_table_write_cmos_sensor(
		addr_data_pair_preview_hi846_24695,
		sizeof(addr_data_pair_preview_hi846_24695) /
		sizeof(kal_uint16));
#else
	LOG_INF("E preview\n");
	////////////////////////////////////////////////////////////
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_fps_hi846_24695[] = {
    0x002E, 0x1111,
    0x0032, 0x1111,
    0x0026, 0x0040,
    0x002C, 0x09CF,
...
kal_uint16 addr_data_pair_capture_30fps_hi846_24695[] = {
    0x002E, 0x1111,
    0x0032, 0x1111,
    0x0026, 0x0040,
    0x002C, 0x09CF,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
	hi846_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_hi846_24695,
		sizeof(addr_data_pair_capture_30fps_hi846_24695) /
		sizeof(kal_uint16));
	} else {
	hi846_table_write_cmos_sensor(
		addr_data_pair_capture_fps_hi846_24695,
		sizeof(addr_data_pair_capture_fps_hi846_24695) /
		sizeof(kal_uint16));
	}
#else
	if (currefps == 300) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_hi846_24695[] = {
    0x002E, 0x1111,
    0x0032, 0x1111,
    0x0026, 0x0172,
    0x002C, 0x089D,
...
#if MULTI_WRITE
	hi846_table_write_cmos_sensor(
		addr_data_pair_video_hi846_24695,
		sizeof(addr_data_pair_video_hi846_24695) /
		sizeof(kal_uint16));
#else
	//Sensor Information////////////////////////////
	//Sensor	  : Hi-846
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_hi846_24695[] = {
    0x002E, 0x3311,
    0x0032, 0x3311,
    0x0026, 0x0238,
    0x002C, 0x07D7,
...
#if MULTI_WRITE
	hi846_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi846_24695,
		sizeof(addr_data_pair_hs_video_hi846_24695) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_hi846_24695[] = {
    0x002E, 0x1111,
    0x0032, 0x1111,
    0x0026, 0x0040,
    0x002C, 0x09CF,
...
#if MULTI_WRITE
	hi846_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi846_24695,
		sizeof(addr_data_pair_slim_video_hi846_24695) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x002E, 0x1111);
	write_cmos_sensor(0x0032, 0x1111);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_hi846_24695[] = {
    0x002E, 0x1111,
    0x0032, 0x1111,
    0x0026, 0x0040,
    0x002C, 0x09CF,
...
#if MULTI_WRITE
	hi846_table_write_cmos_sensor(
		addr_data_pair_custom1_hi846_24695,
		sizeof(addr_data_pair_custom1_hi846_24695) /
		sizeof(kal_uint16));
#else
	LOG_INF("E custom1\n");
	write_cmos_sensor(0x002E, 0x1111);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom2_hi846_24695[] = {
    0x002E, 0x3311,
    0x0032, 0x3311,
    0x0026, 0x0040,
    0x002C, 0x09CF,
...
#if MULTI_WRITE
	hi846_table_write_cmos_sensor(
		addr_data_pair_custom2_hi846_24695,
		sizeof(addr_data_pair_custom2_hi846_24695) /
		sizeof(kal_uint16));
#else
	LOG_INF("E custom2\n");
	write_cmos_sensor(0x002E, 0x3311);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom3_hi846_24695[] = {
    0x002E, 0x3311,
    0x0032, 0x3311,
    0x0026, 0x0040,
    0x002C, 0x09CF,
...
#if MULTI_WRITE
	hi846_table_write_cmos_sensor(
		addr_data_pair_custom3_hi846_24695,
		sizeof(addr_data_pair_custom3_hi846_24695) /
		sizeof(kal_uint16));
#else
	LOG_INF("E custom3\n");
	//Sensor Information////////////////////////////
...
kal_uint16 addr_data_pair_custom4_hi846_24695[] = {
	0x002E, 0x1111,
	0x0032, 0x1111,
	0x0026, 0x02EC,
	0x002C, 0x0723,
...
{
	hi846_table_write_cmos_sensor(
		addr_data_pair_custom4_hi846_24695,
		sizeof(addr_data_pair_custom4_hi846_24695) /
		sizeof(kal_uint16));
}
