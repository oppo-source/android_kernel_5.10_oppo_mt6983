...
#include "ov02b1bmipimono_adoki_Sensor.h"


#define PFX "ov02b1b_adoki_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV02B1B_SENSOR_ID_ADOKI,
	.module_id = 0x54, //0x54 C&T
...
//#ifdef OPLUS_FEATURE_CAMERA_COMMON
#define OV02B1B_MONO_ADOKI_EEPROM_I2C_ADDR 0xA2
static BYTE ov02b1b_mono_adoki_common_data[CAMERA_EEPPROM_COMDATA_LENGTH] = { 0 };

static void read_ov02b1b_mono_adoki_module_data(UINT32 sensor_id)
{
// ov02b1b_mono_adoki_common_data
// length   : 64
// sensorid : [30 ~ 33]

	kal_uint16 idx = 0;
	memset(ov02b1b_mono_adoki_common_data, 0,sizeof(ov02b1b_mono_adoki_common_data));
	//sensor id
	ov02b1b_mono_adoki_common_data[30] = ((sensor_id) >> 24) & 0xff;
	ov02b1b_mono_adoki_common_data[31] = ((sensor_id) >> 16) & 0xff;
	ov02b1b_mono_adoki_common_data[32] = ((sensor_id) >> 8) & 0xff;
	ov02b1b_mono_adoki_common_data[33] = (sensor_id) & 0xff;

	for (idx = 0; idx < CAMERA_EEPPROM_COMDATA_LENGTH; idx = idx + 4)
		LOG_INF("cam data: %02x %02x %02x %02x\n",
		       ov02b1b_mono_adoki_common_data[idx],
		       ov02b1b_mono_adoki_common_data[idx + 1],
		       ov02b1b_mono_adoki_common_data[idx + 2],
		       ov02b1b_mono_adoki_common_data[idx + 3]);
}
...
//#ifdef OPLUS_FEATURE_CAMERA_COMMON
			read_ov02b1b_mono_adoki_module_data(*sensor_id);
//#endif  /* OPLUS_FEATURE_CAMERA_COMMON */
...
//#ifdef OPLUS_FEATURE_CAMERA_COMMON
	...
	case SENSOR_FEATURE_GET_EEPROM_COMDATA:
		memcpy(feature_return_para_32, ov02b1b_mono_adoki_common_data,
