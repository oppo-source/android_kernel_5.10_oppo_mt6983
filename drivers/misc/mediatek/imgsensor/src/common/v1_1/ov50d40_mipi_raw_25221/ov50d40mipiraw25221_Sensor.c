...
#include "ov50d40mipiraw25221_Sensor.h"
#include "ov50d40_Sensor25221_setting.h"
...
#define DEVICE_VERSION_OV50D40_25221     "ov50d40_25221"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV50D40_SENSOR_ID_25221,
            ...
            *sensor_id = return_sensor_id();
            if (*sensor_id == OV50D40_SENSOR_ID) {
                *sensor_id = imgsensor_info.sensor_id;
                pr_info("[get_imgsensor_id] OV50D40_25221 Read sensor id Success, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
                if(deviceInfo_register_value == 0x00) {
                    imgsensor_info.module_id = read_ov50d40_eeprom_module(MODULE_ID_OFFSET);
                    register_imgsensor_deviceinfo("Cam_r", DEVICE_VERSION_OV50D40_25221, imgsensor_info.module_id);
            ...
            pr_info("[get_imgsensor_id] OV50D40_25221 Read sensor id fail, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
            retry--;
        } while (retry > 0);
            i++;
        retry = 2;
...
static kal_uint32 open(void)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            ...
            if (sensor_id == OV50D40_SENSOR_ID) {
                sensor_id = imgsensor_info.sensor_id;
                pr_info("[Open] OV50D40_25221 Read sensor id Success, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, sensor_id);
                break;
            }
            pr_info("[Open] OV50D40_25221 Read sensor id fail, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, sensor_id);
            retry--;
        } while (retry > 0);
            i++;
        if (sensor_id == imgsensor_info.sensor_id)
...
UINT32 OV50D40_MIPI_RAW_25221_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
