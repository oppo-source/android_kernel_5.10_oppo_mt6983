...
#include "gc32e2mipiraw_25221_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC32E2_SENSOR_ID_25221,
...
kal_uint16 gc32e2_25221_init_addr_data[] = {
    0x1320,0x01,
    0x1321,0x00,
    0x0315,0x80,
    0x0aaf,0x00,
...
static void sensor_init(void)
{
    ...
    table_write_cmos_sensor(gc32e2_25221_init_addr_data,
        sizeof(gc32e2_25221_init_addr_data)/sizeof(kal_uint16));
    pr_debug("[%s] init_End\n", __func__);
}   /*    sensor_init  */
            ...
            *sensor_id = return_sensor_id();
            if (*sensor_id == GC32E2_SENSOR_ID) {
                *sensor_id = imgsensor_info.sensor_id;
                pr_info("[get_imgsensor_id] gc32e2_25221 Read sensor id Success, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
                ...
                if (otp_data[0] == 0) {
                    ...
                    gc32e2_25221_otp_identify();
                } else {
                    pr_info("otp data has already read");
                }
                return ERROR_NONE;
            }
            pr_info("[get_imgsensor_id] gc32e2_25221 Read sensor id fail, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
            retry--;
        } while (retry > 0);
        i++;
        retry = 2;
...
static kal_uint32 open(void)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            ...
            if (sensor_id == GC32E2_SENSOR_ID) {
                sensor_id = imgsensor_info.sensor_id;
                pr_info("[Open] GC32E2_25221 Read sensor id Success, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, sensor_id);
                break;
            }
            pr_info("[Open] GC32E2_25221 Read sensor id fail, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, sensor_id);
            retry--;
        } while (retry > 0);
            i++;
        if (sensor_id == imgsensor_info.sensor_id)
...
/*************************PDAF END*************************/
    ...
    case SENSOR_FEATURE_GET_4CELL_DATA: /*get 4 cell data from eeprom*/
    {
        ...
        if (type == FOUR_CELL_CAL_TYPE_XTALK_CAL)
            gc32e2_25221_copy_crosstalk_data(ct_data);
        break;
    }
...
UINT32 GC32E2_MIPI_RAW_25221_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
