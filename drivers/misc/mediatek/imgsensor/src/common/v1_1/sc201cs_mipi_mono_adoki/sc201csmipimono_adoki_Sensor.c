...
#include "sc201csmipimono_adoki_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "sc201cs_adoki_mipi_mono"
...
#define DEVICE_VERSION    "sc201cs_mono"
//#endif
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = SC201CS_SENSOR_ID_ADOKI,
    .module_id = 0x57, //0x57 lce
    ...
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_MONO,    //ADD,2021/8/26,fix depth sc201cs output_dataformat
...
//#ifdef OPLUS_FEATURE_CAMERA_COMMON
#define SC201CS_MONO_ADOKI_EEPROM_I2C_ADDR 0xA2
static BYTE sc201cs_mono_adoki_common_data[CAMERA_EEPPROM_COMDATA_LENGTH] = { 0 };

static void read_sc201cs_mono_adoki_module_data(UINT32 sensor_id)
{
// sc201cs_mono_adoki_common_data
// length   : 64
// sensorid : [30 ~ 33]
    kal_uint16 idx = 0;
	memset(sc201cs_mono_adoki_common_data, 0,sizeof(sc201cs_mono_adoki_common_data));
    //sensor id
    sc201cs_mono_adoki_common_data[30] = ((sensor_id) >> 24) & 0xff;
	sc201cs_mono_adoki_common_data[31] = ((sensor_id) >> 16) & 0xff;
	sc201cs_mono_adoki_common_data[32] = ((sensor_id) >> 8) & 0xff;
	sc201cs_mono_adoki_common_data[33] = (sensor_id) & 0xff;
    for (idx = 0; idx < CAMERA_EEPPROM_COMDATA_LENGTH; idx = idx + 4)
	    LOG_INF("cam data: %02x %02x %02x %02x\n",
		       sc201cs_mono_adoki_common_data[idx],
		       sc201cs_mono_adoki_common_data[idx + 1],
		       sc201cs_mono_adoki_common_data[idx + 2],
		       sc201cs_mono_adoki_common_data[idx + 3]);
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
            ...
            if (*sensor_id == SC201CS_SENSOR_ID_DOKI) {
                *sensor_id = imgsensor_info.sensor_id; //SC201CS_SENSOR_ID_ADOKI
...
//#ifdef OPLUS_FEATURE_CAMERA_COMMON
                read_sc201cs_mono_adoki_module_data(*sensor_id);
//#endif  /* OPLUS_FEATURE_CAMERA_COMMON */
                return ERROR_NONE;
            }
            LOG_INF("find sensor fail, id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
            retry--;
        } while(retry > 0);
        i++;
        retry = 2;
...
//#ifdef OPLUS_FEATURE_CAMERA_COMMON
        ...
        case SENSOR_FEATURE_GET_EEPROM_COMDATA:
            memcpy(feature_return_para_32, sc201cs_mono_adoki_common_data,
