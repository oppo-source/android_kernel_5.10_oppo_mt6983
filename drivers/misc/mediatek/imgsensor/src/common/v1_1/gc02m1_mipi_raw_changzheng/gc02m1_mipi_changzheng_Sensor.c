...
// QR       : [8 ~ 26]
	...
	//module id
	gc02m1_changzheng_common_data[0] = read_gc02m1_changzheng_eeprom_module(moduleAddr);
	gc02m1_changzheng_common_data[1] = read_gc02m1_changzheng_eeprom_module(moduleAddr + 1);
	//sensor id
	gc02m1_changzheng_common_data[2] = read_gc02m1_changzheng_eeprom_module(sensorAddr);
	gc02m1_changzheng_common_data[3] = read_gc02m1_changzheng_eeprom_module(sensorAddr + 1);
	//lens id
	gc02m1_changzheng_common_data[4] = read_gc02m1_changzheng_eeprom_module(lensAddr);
	gc02m1_changzheng_common_data[5] = read_gc02m1_changzheng_eeprom_module(lensAddr + 1);
	//vcm id
	gc02m1_changzheng_common_data[6] = read_gc02m1_changzheng_eeprom_module(vcmAddr);
	gc02m1_changzheng_common_data[7] = read_gc02m1_changzheng_eeprom_module(vcmAddr + 1);
