 ...
 *
 ****************************************************************************/
#ifndef _CHANGZHENG_OV32CMIPI_SENSOR_H
#define _CHANGZHENG_OV32CMIPI_SENSOR_H

#define USHORT			unsigned short
#define BYTE			unsigned char
#define Sleep(ms) mdelay(ms)

#define CHANGZHENG_OV32C_EEPROM_READ_ID   0xA0
#define CHANGZHENG_OV32C_EEPROM_WRITE_ID  0xA1
