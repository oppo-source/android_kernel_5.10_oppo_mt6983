...
int aw37004_camera_power_up(int out_iotype, unsigned int out_val)
{
    ...
    if (CHIP_ID2 == reg_val) //wl28661d
    {
        pr_info("ldo is wl28661d, enable wl28661d dischager function\n");
        ret = aw37004_i2c_write(camera_chip, aw37004_on_config[DISCHARGE_ENABLE].reg, aw37004_on_config[DISCHARGE_ENABLE].value);
        if (ret < 0)
        {
            pr_err("wl28661d dischager function enable failed\n");
    ...
    case OUT_DVDD1:
        ...
        } else if (reg_val == CHIP_ID2) {
            reg_val = (out_val - 600) / 6; // DVDD1 = 0.6V + DVDD1_VOUT[7:0] * 0.006V-wl2866d
        }
    ...
    case OUT_AVDD1:
        ...
        if (reg_val == CHIP_ID) {
            ...
            reg_val = (out_val * 10 - 12000) / 125; // AVDD1 = 1.2V + AVDD1_VOUT[7:0] * 0.0125V-wl2866d
        }
