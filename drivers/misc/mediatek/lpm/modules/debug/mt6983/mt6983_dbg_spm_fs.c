...
ssize_t mt6983_spm_system_stats_read(char *ToUserBuf, size_t sz, void *priv)
{
#if IS_ENABLED(CONFIG_MTK_ECCCI_DRIVER)
	u32 len = 0;
	u32 *share_mem = NULL;
...
static const struct mtk_lp_sysfs_op mt6983_spm_system_stats_fops = {
	.fs_read = mt6983_spm_system_stats_read,
};
...
int lpm_spm_fs_init(void)
{
	...
	mtk_spm_sysfs_entry_node_add("system_stats", 0444
			, &mt6983_spm_system_stats_fops, NULL);
