...
static const struct i2c_hid_quirks {
	...
	{ OPLUS_KEYBOARD_VID, OPLUS_KEYBOARD_PID, I2C_HID_QUIRK_RESET_ON_RESUME },
	{ OPLUS_TOUCHPAD_VID, OPLUS_TOUCHPAD_PID, I2C_HID_QUIRK_RESET_ON_RESUME },
	{ 0, 0 }
};
