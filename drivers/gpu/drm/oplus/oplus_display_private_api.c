...
int panel_serial_number_read(struct drm_crtc *crtc, char cmd, int num)
{
	...
	char BL4_NT37703A[] = {0xF0, 0x55, 0xAA, 0x52, 0x08, 0x00};
	char BL4_ILI97601A[] = {0xFF, 0x5A, 0xA5, 0x1D};
	char BL4_ILI97601A_default[] = {0xFF, 0x5A, 0xA5, 0x00};
	...
	if (!strcmp(panel_name, "ac328_p_3_a0025_vdo_panel")) {
		pr_info("ac328_p_3_a0025_vdo_panel set page0\n");
		ddic_dsi_send_cmd(sizeof(BL4_NT37703A), BL4_NT37703A);
	}

	if (!strcmp(panel_name, "ac328_p_b_a0029_vdo_panel")) {
		pr_info("ac328_p_b_a0029_vdo_panel set page1D\n");
		ddic_dsi_send_cmd(sizeof(BL4_ILI97601A), BL4_ILI97601A);
	}
	...
	while (count > 0) {
		...
		} else if ((!strcmp(panel_name, "ac328_p_b_a0029_vdo_panel"))
			|| (!strcmp(panel_name, "ac328_p_3_a0025_vdo_panel"))) {
			panel_serial_info.reg_index = 0;
	...
	if (!strcmp(panel_name, "ac328_p_b_a0029_vdo_panel")) {
		pr_info("ac328_p_b_a0029_vdo_panel set page1D\n");
		ddic_dsi_send_cmd(sizeof(BL4_ILI97601A_default), BL4_ILI97601A_default);
	}
