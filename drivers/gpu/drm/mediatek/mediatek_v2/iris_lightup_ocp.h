#ifndef __IRIS_LIGHTUP_OCP_H__
#define __IRIS_LIGHTUP_OCP_H__
...
int iris_dsi_send_cmds(struct iris_cmd_desc *cmds, u32 count, enum dsi_cmd_set_state state);
...
int iris_convert_panel_cmds(struct iris_cmd_set *cmdset,
...
int iris_dsi_send_cmds_lockcmdq(
		...
		enum dsi_cmd_set_state state, int need_lock, struct cmdq_pkt *);
