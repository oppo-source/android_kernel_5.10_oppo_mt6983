...
struct iris_cmd_desc iris_lightup_cmds[] = {
	//mipi rx phy
...
struct iris_cmd_desc iris_lightoff_cmds[] = {
...
static struct iris_cmd_set iris_panel_cmds;
static struct iris_cmd_set iris_panel_off_cmds;
