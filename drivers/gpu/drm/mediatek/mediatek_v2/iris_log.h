...
extern void drm_trace_tag_start(const char *tag);
extern void drm_trace_tag_end(const char *tag);
extern void drm_trace_tag_mark(const char *tag);
extern void drm_trace_tag_value(const char *tag, unsigned int value);
...
#define IRIS_ATRACE_BEGIN(name)	\
		...
		drm_trace_tag_start(name)

#define IRIS_ATRACE_END(name)	\
		if (iris_get_trace_en())	\
		drm_trace_tag_end(name)

#define IRIS_ATRACE_MARK(name)	\
		if (iris_get_trace_en())	\
		drm_trace_tag_mark(name)

#define IRIS_ATRACE_INT(name, value)	\
		if (iris_get_trace_en())	\
		drm_trace_tag_value(name, value)
